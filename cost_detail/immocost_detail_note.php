...
/**
 *  \file       immocost_detail_note.php
 *  \ingroup    ultimateimmo
 *  \brief      Car with notes on ImmoCost_Detail
 */
...
$hookmanager->initHooks(array('immocost_detailnote','globalcard'));     // Note that conf->hooks_modules contains array
