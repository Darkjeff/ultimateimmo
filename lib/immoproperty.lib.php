...
function immopropertyPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/ultimateimmo/property/immoproperty_card.php", 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/ultimateimmo/property/immoproperty_agenda.php", 1).'?id='.$object->id;
	...
	//	'entity:-tabname:Title:@ultimateimmo:/ultimateimmo/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, $object, $head, $h, 'immoproperty@ultimateimmo');
