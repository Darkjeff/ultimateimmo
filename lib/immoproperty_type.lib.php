...
function immoproperty_typePrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/immobilier/property/immoproperty_type_card.php", 1).'?id='.$object->id;
	...
	$upload_dir = $conf->immobilier->dir_output . "/property/" . dol_sanitizeFileName($object->ref);
	...
	$head[$h][0] = dol_buildpath("/immobilier/property/immoproperty_type_agenda.php", 1).'?id='.$object->id;
	...
	//	'entity:-tabname:Title:@immobilier:/immobilier/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, $object, $head, $h, 'immoproperty_type@immobilier');
