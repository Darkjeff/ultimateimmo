...
/**
 *  \file       immocost_agenda.php
 *  \ingroup    ultimateimmo
 *  \brief      Page of ImmoCost events
 */
...
$hookmanager->initHooks(array('immocostagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0) {
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("ImmoCost"), -1, 'ultimateimmo@ultimateimmo');
	...
	if (isModEnabled('agenda') && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read))) {
		...
		/*print load_fiche_titre($langs->trans("ActionsOnImmoCost"),'','');
