...
if (empty($reshook))
{
	...
	$uploaddir = $conf->ultimateimmo->dir_output . '/cost/';
...
$newcardbutton='';
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/ultimateimmo/cost/immocost_card.php', 1) . '?action=create&backtopage=' . urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
