...
/**
 *  \file       immocost_note.php
 *  \ingroup    ultimateimmo
 *  \brief      Car with notes on ImmoCost
 */
...
$hookmanager->initHooks(array('immocostnote'));     // Note that conf->hooks_modules contains array
...
llxHeader('', $langs->trans('ImmoCost'), $wikihelp);
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("ImmoCost"), -1, 'immocost@ultimateimmo');
