...
/**
 *  \file       immocost_document.php
 *  \ingroup    ultimateimmo
 *  \brief      Tab for documents linked to ImmoCost
 */
...
$hookmanager->initHooks(array('immocostdocument'));     // Note that conf->hooks_modules contains array
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("ImmoCost"), -1, 'immocost@ultimateimmo');
