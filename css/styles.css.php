...
div.mainmenu.biens {
	background-image: url(<?php echo dol_buildpath('custom/immobilier/img/property.png',1) ?>);
}

div.mainmenu.renters {
	background-image: url(<?php echo dol_buildpath('custom/immobilier/img/renter.png',1) ?>);
}
...
div.mainmenu.rentalloads {
	background-image: url(<?php echo dol_buildpath('custom/immobilier/img/cost.png',1) ?>);
}

div.mainmenu.result {
	background-image: url(<?php echo dol_buildpath('custom/immobilier/img/result.png',1) ?>);
}
