...
$permissiontoadd = $user->hasRight('ultimateimmo','rent','write'); // Used by the include of actions_addupdatedelete.inc.php
$permissiontoread = $user->hasRight('ultimateimmo','rent','read'); // Used by the include of actions_addupdatedelete.inc.php
/*
 * Actions
 */
...
if ($object->id) {
	...
	//$permission = $user->hasRight('ultimateimmo','rent','write');
	$permission = 1;
	//$permtoedit = $user->hasRight('ultimateimmo','rent','write');
	$permtoedit = 1;
	$param = '&id=' . $object->id;
