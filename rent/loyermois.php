...
/**
 * \file        immobilier/loyermois.php
 * \ingroup     immobilier
 * \brief       Page loyer mois
 */
 ...
 * View
 */
llxHeader ( '', $langs->trans("RentsByYear"));
...
print load_fiche_titre ( $langs->trans("Rents")." ".$textprevyear." ".$langs->trans("Year")." ".$year_start." ".$textnextyear);
