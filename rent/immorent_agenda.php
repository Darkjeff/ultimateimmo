...
/**
 *  \file       immorent_agenda.php
 *  \ingroup    immobilier
 *  \brief      Page of ImmoRent events
 */
...
$hookmanager->initHooks(array('immorentagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("ImmoRent"), -1, 'immorent@immobilier');
