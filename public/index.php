...
if (empty($user->id)) {
        ...
        if ($resql < 0) {
            ...
            if ($num > 0) {
                ...
                while ($obj = $db->fetch_object($resql)) {
                    $newObj = new stdClass();
                    if (array_key_exists($obj->fk_immoproperty, $resultDataCompteur) && array_key_exists($obj->yearrelever, $resultDataCompteur[$obj->fk_immoproperty]) && array_key_exists($obj->typecounterid, $resultDataCompteur[$obj->fk_immoproperty][$obj->yearrelever])) {
    ...
    <main>
        ...
        <div class="container mb-4" id="recepit">
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center"><?= $langs->trans('MenuListImmoReceipt'); ?></h4>
        ...
        <?php if (!empty($resultDataCompteur)) { ?>
            <div class="container mb-4" id="dataCompteur">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center"><?= $langs->trans('MenuImmoCompteur'); ?></h4>
                            <div style="max-height: 500px;overflow: auto;">
        ...
        <?php if (!empty($resultDataBilan)) { ?>
            <div class="container mb-4" id="dataBilan">
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-center"><?= $langs->trans('DetailPayment'); ?></h4>
                            <div style="max-height: 500px;overflow: auto;">
