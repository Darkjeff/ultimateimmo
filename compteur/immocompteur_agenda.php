...
/**
 *  \file       immocompteur_agenda.php
 *  \ingroup    ultimateimmo
 *  \brief      Page of ImmoCompteur events
 */
...
$hookmanager->initHooks(array('immocompteuragenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	if (!empty($conf->agenda->enabled) && (!empty($user->hasRight('agenda','myactions','read')) || !empty($user->hasRight('agenda','allactions','read'))))
	{
		...
		//print load_fiche_titre($langs->trans("ActionsOnImmoCompteur"), '', '');
