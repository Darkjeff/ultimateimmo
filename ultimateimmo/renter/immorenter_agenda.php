...
/**
 *  \file       immorenter_agenda.php
 *  \ingroup    ultimateimmo
 *  \brief      Page of ImmoRenter events
 */
...
$hookmanager->initHooks(array('immorenteragenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("ImmoRenter"), -1, 'immorenter@ultimateimmo');
