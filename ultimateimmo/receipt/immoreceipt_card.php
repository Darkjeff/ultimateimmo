...
/* *************************************************************************** */
	...
	if ($action == 'createall') 
	{
		 ...
		 * List of contracts
		 */
		$sql = "SELECT c.rowid as contractid, c.ref as contract, loc.lastname as rentername, o.firstname as ownername, l.ref as localref, l.address, l.label as local, c.totalamount as total, c.rentamount , c.chargesamount, c.fk_renter as reflocataire, c.fk_property as reflocal, c.preavis as preavis, c.vat, l.fk_owner, o.rowid, o.fk_soc, l.fk_owner";
