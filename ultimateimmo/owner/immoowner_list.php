...
/**
 *   	\file       immoowner_list.php
 *		\ingroup    ultimateimmo
 *		\brief      List page for immoowner
 */
...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'immoownerlist';   // To manage different context of search
...
//$help_url="EN:Module_ImmoOwner|FR:Module_ImmoOwner_FR|ES:Módulo_ImmoOwner";
$help_url='';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("MenuImmoOwner"));
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: " . dol_buildpath('/ultimateimmo/owner/immoowner_card.php', 1) . '?id=' . $id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/ultimateimmo/owner/immoowner_card.php', 1) . '?action=create&backtopage=' . urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'address', 0, $newcardbutton, '', $limit);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendImmoOwnerRef";
$modelmail = "immoowner";
$objecttmp = new ImmoOwner($db);
