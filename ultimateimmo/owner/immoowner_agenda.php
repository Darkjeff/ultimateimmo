...
/**
 *  \file       immoowner_agenda.php
 *  \ingroup    ultimateimmo
 *  \brief      Page of ImmoOwner events
 */
...
$hookmanager->initHooks(array('immoowneragenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("ImmoOwner"), -1, 'immoowner@ultimateimmo');
    ...
    /*if (! empty($conf->agenda->enabled) && (!empty($user->rights->agenda->myactions->read) || !empty($user->rights->agenda->allactions->read) ))
    {
		...
		print load_fiche_titre($langs->trans("ActionsOnImmoOwner"),'','');
