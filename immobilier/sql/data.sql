...
insert into llx_c_immo_type_property (id,code,label) values (1, 'apa', 'Apartment');
insert into llx_c_immo_type_property (id,code,label) values (2, 'hou', 'Individual house');
insert into llx_c_immo_type_property (id,code,label) values (3, 'loc', 'Business premises');
insert into llx_c_immo_type_property (id,code,label) values (4, 'sho', 'Shop');
insert into llx_c_immo_type_property (id,code,label) values (5, 'gar', 'Garage');
insert into llx_c_immo_type_property (id,code,label) values (6, 'bul', 'Building');
...
INSERT INTO  llx_c_immo_type_compteur (rowid,code,intitule,sort,active) VALUES (1,'EAU','Eau',1,1);
INSERT INTO  llx_c_immo_type_compteur (rowid,code,intitule,sort,active) VALUES (2,'ELEC','Electricité',2,1);
