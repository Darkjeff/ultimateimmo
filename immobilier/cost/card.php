...
if ($action == 'add' && $user->rights->immobilier->property->write) {
	...
	$object->fk_property = GETPOST("fk_property", 'alpha');
	$object->label = GETPOST("label", 'alpha');
	$object->socid = GETPOST("societe", 'alpha');
	$object->fk_property = GETPOST("fk_property", 'alpha');
	$object->cost_type = GETPOST("cost_type", 'alpha');
	...
	$object->fk_owner = GETPOST("fk_owner", 'alpha');
