    ...
    public function __construct($db)
    {
        ...
        $this->dictionaries = array(
            ...
            'tabname' => array(
                ...
                MAIN_DB_PREFIX . "c_ultimateimmo_typeent",
            ),
            'tablib' => array(
                "DiagnosticImmo",
                "ImmorentType",
            ...
            'tabfield' => array(
                "code,label", "code,label", "code,label", "code,label", "code,label", "ref,label,famille,status", "ref,label", "date_start,date_end,type_indice,amount", "code,label"
            ),
            'tabfieldvalue' => array(
                "code,label", "code,label", "code,label", "code,label", "code,label", "ref,label,famille,status", "ref,label", "date_start,date_end,type_indice,amount", "code,label"
            ),
            ...
            'tabrowid' => array(
                "rowid", "rowid", "rowid", "rowid", "rowid", "rowid", "rowid", "rowid", "rowid"
            ),
            'tabcond' => array(
...
///Owner
    ...
    public function init($options = '')
    {
        ...
        $result1 = $extrafields->addExtraField('civility', 'Civility', 'sellist', 1, null, 'thirdparty', 0, 0, '1', array('options' => ['c_civility:label:rowid::active=1'=>null]), 0, '', 1, 'Civility', '', 0, 'companies', '$conf->ultimateimmo->enabled', 0, 2, ['css' => 'civility', 'csslist' => 'civility', 'cssview' => 'civility']);
        $result2 = $extrafields->addExtraField('firstname', 'Firstname', 'varchar', 2, 255, 'thirdparty', 0, 0, '', '', 0, '', 1, 'Firstname', '', 0, 'companies', '$conf->ultimateimmo->enabled', 0, 2, ['css' => 'firstname', 'csslist' => 'firstname', 'cssview' => 'firstname']);
        $result3 = $extrafields->addExtraField('typeent', 'TypeEntiteImmo', 'sellist', 3, null, 'thirdparty', 0, 0, '1', array('options' => ['c_ultimateimmo_typeent:label:rowid::active=1'=>null]), 0, '', 1, 'TypeEnt', '', 0, 'ultimateimmo@ultimateimmo', '$conf->ultimateimmo->enabled', 0, 0, ['css' => 'typeent', 'csslist' => 'typeent', 'cssview' => 'typeent']);
        ...
        foreach ($myTmpObjects as $myTmpObjectKey => $myTmpObjectArray) {
            if ($myTmpObjectKey == 'ImmoCompteur')
                continue;
