...
/**
 *	\file       htdocs/core/modules/immorent/mod_immorent_simple.php
...
class mod_immorent_simple extends ModeleNumRefUltimateimmo
{
	...
	function getNextValue($object)
    {
		...
		{
			dol_syslog("mod_immorent_simple::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_immorent_simple::getNextValue return ".$this->prefix.$yymm."-".$num);
     ...
     */
    function immorent_get_num($object='')
    {
