...
/**
 *	\file       ultimateimmo/core/modules/ultimateimmo/mod_ultimateimmo_standard.php
 *	\ingroup    ultimateimmo
 *	\brief      File of class to manage ultimateimmo numbering rules standard
 */
...
/**
 * 	Class to manage the numbering module standard for ultimateimmo references
 */
class mod_ultimateimmo_standard extends ModeleNumRefUltimateimmo
{
	/**
	...
	public function getNextValue($object)
    {
		...
		dol_syslog("mod_ultimateimmo_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
