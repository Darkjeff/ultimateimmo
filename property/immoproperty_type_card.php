...
if ($action == 'create')
{
	print load_fiche_titre($langs->trans("NewImmoPropertyType"));
	...
	*/
	...
	if ($action != 'presend')
	{
		...
		*/
		...
		$morehtmlright = '<a href="'.dol_buildpath('/immobilier/property/immoproperty_type_agenda.php', 1).'?id='.$object->id.'">';
