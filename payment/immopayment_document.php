...
if ($id > 0 || ! empty($ref)) $upload_dir = $conf->ultimateimmo->multidir_output[$object->entity] . "/payment/" . dol_sanitizeFileName($object->ref);
...
if ($object->id)
{
	...
	dol_fiche_head($head, 'document', $langs->trans("ImmoPayment"), -1, 'ultimateimmo@ultimateimmo');
	...
	$relativepathwithnofile='payment/' . dol_sanitizeFileName($object->ref).'/';
