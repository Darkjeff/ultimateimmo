...
/**
 *      \file       ultimateimmo/admin/renter_extrafields.php
...
$elementtype = 'ultimateimmo_immorenter'; // Must be the $table_element of the class that manage extrafield
...
$textobject = $langs->transnoentitiesnoconv("Renters");
...
print dol_get_fiche_head($head, 'attributes_renter', $langs->trans("ModuleUltimateimmoName"), 0, 'building@ultimateimmo');
