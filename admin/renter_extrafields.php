...
/**
 *      \file       immobilier/admin/renter_extrafields.php
 *		\ingroup    immobilier
...
$elementtype='immobilier_immorenter'; // Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'attributes_renter', $langs->trans("ModuleImmobilierName"), 0, 'building@immobilier');
