...
/**
 *      \file       immobilier/admin/owner_extrafields.php
 *		\ingroup    immobilier
...
$elementtype='immobilier_immoowner'; // Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'attributes_owner', $langs->trans("ModuleImmobilierName"), 0, 'building@immobilier');
