...
/**
 *      \file       ultimateimmo/admin/owner_extrafields.php
...
$elementtype = 'ultimateimmo_immoowner'; // Must be the $table_element of the class that manage extrafield
...
$textobject = $langs->transnoentitiesnoconv("Owners");
...
print dol_get_fiche_head($head, 'attributes_owner', $langs->trans("ModuleUltimateimmoName"), 0, 'building@ultimateimmo');
