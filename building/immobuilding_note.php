...
/**
 *  \file       immobuilding_note.php
 *  \ingroup    ultimateimmo
 *  \brief      Tab for notes on ImmoBuilding
 */
...
$hookmanager->initHooks(array('immobuildingnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
$help_url = '';
llxHeader('', $langs->trans('ImmoBuilding'), $help_url);
