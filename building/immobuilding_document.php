...
/**
 *  \file       immobuilding_document.php
 *  \ingroup    ultimateimmo
 *  \brief      Tab for documents linked to ImmoBuilding
 */
...
$hookmanager->initHooks(array('immobuildingdocument', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id) {
	...
	//$relativepathwithnofile='immobuilding/' . dol_sanitizeFileName($object->id).'/';
	$relativepathwithnofile = 'immobuilding/'.dol_sanitizeFileName($object->ref).'/';
