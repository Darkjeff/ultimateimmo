...
if ($action == 'create') {
	...
	print '</td></tr>';
	print '<tr><td>'.$langs->trans("Immeuble").'</td>';
	print '<td>';
...
if ($id > 0) {
	...
	print '<tr>';
	print '<td>'.$langs->trans("fournisseur").'</td>';
	print '<td>';
	print $htmlimmo->select_fournisseur($charge->fournisseur, 'fournisseur', 1);
	print '</td>';
	print '</tr>';
	
	print '<tr><td>'.$langs->trans("nouveau_fournisseur").'</td>';
	print '<td><input name="nouveau_fournisseur" size="30" value="' . $charge->nouveau_fournisseur . '"</td>';
	print '</tr>';
	...
	print '<tr>';
	print '<td>'.$langs->trans("nouveau_fournisseur").'type</td>';
	print '<td>';
	print $htmlimmo->select_type($charge->type, 'type');
	print '</td>';
	print '</tr>';
	...
	print '<tr>';
	print '<td>'.$langs->trans("periode_du").'</td>';
	print '<td align="left">';
	...
	print '<tr>';
	print '<td>'.$langs->trans("periode_au").'</td>';
	print '<td align="left">';
	...
	print '<tr><td>'.$langs->trans("statut").'</td>';
	...
	*/
	...
	$sql = "SELECT icd.rowid, icd.local_id, icd.charge_id, icd.montant as amount, icd.type, ll.nom as nomlocal";
