...
/**
 *  \file       immoowner_type_note.php
 *  \ingroup    immobilier
 *  \brief      Car with notes on ImmoOwner_Type
 */
...
$help_url='';
llxHeader('',$langs->trans('MenuImmoOwnerType'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("MenuImmoOwnerType"), -1, 'immobilier@immobilier');
