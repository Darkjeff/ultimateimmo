...
/**
 *   	\file       immorenter_type_list.php
 *		\ingroup    ultimateimmo
 *		\brief      List page for immorenter_type
 */
...
$contextpage= GETPOST('contextpage','aZ')?GETPOST('contextpage','aZ'):'immorenter_typelist';   // To manage different context of search
...
$hookmanager->initHooks(array('immoowner_typelist'));     // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass='ImmoOwner_Type';
	$objectlabel='ImmoOwner_Type';
...
$help_url='';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("MenuImmoOwnerType"));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."immoowner_type_extrafields as ef on (t.rowid = ef.fk_object)";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/ultimateimmo/owner_type/immoowner_type_card.php',1).'?id='.$id);
	exit;
}
...
$newcardbutton='';
$newcardbutton='<a class="butActionNew" href="' .dol_buildpath('/ultimateimmo/owner_type/immoowner_type_card.php',1) . '?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']).'"><span class="valignmiddle">'.$langs->trans('New').'</span>';
...
$topicmail="SendImmoOwner_TypeRef";
$modelmail="immoowner_type";
$objecttmp=new ImmoOwner_Type($db);
