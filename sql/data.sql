...
INSERT INTO llx_c_email_templates (entity, module, type_template, lang, private, fk_user, datec, label, position, active, topic, content, content_lines, enabled, joinfiles) values (0, 'ultimateimmo', 'immorenter', '', 0, null, null, '(SendReminderForExpiredRentLimitTitle)',       10, 1, '[__[MAIN_INFO_SOCIETE_NOM]__] __(ReminderForExpiredRentLimit)__', '__(Hello)__,<br /><br />__(ExampleOfContentForExpiredRentLimit)__<br /><br /><br />__(Sincerely)__<br />__USER_SIGNATURE__', null, '1', null);
...
ALTER TABLE llx_ultimateimmo_immorenter ADD COLUMN fk_project integer NOT NULL;
...
ALTER TABLE llx_ultimateimmo_immoreceipt ALTER COLUMN paye VARCHAR(64);
ALTER TABLE llx_ultimateimmo_immoreceipt ALTER COLUMN vat_tx DOUBLE(6,3) NULL DEFAULT NULL; 
