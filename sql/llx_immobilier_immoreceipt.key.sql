...
ALTER TABLE llx_immobilier_immoreceipt ADD INDEX idx_immobilier_immoreceipt_entity (entity);
ALTER TABLE llx_immobilier_immoreceipt ADD CONSTRAINT llx_immobilier_immoreceipt_fk_rent FOREIGN KEY (fk_rent) REFERENCES immobilier_immorent(rowid);
ALTER TABLE llx_immobilier_immoreceipt ADD INDEX idx_immobilier_immoreceipt_fk_property (fk_property);
ALTER TABLE llx_immobilier_immoreceipt ADD CONSTRAINT llx_immobilier_immoreceipt_fk_property FOREIGN KEY (fk_property) REFERENCES immobilier_immoproperty(rowid);
ALTER TABLE llx_immobilier_immoreceipt ADD INDEX idx_immobilier_immoreceipt_fk_renter (fk_renter);
ALTER TABLE llx_immobilier_immoreceipt ADD CONSTRAINT llx_immobilier_immoreceipt_fk_renter FOREIGN KEY (fk_renter) REFERENCES immobilier_immorenter(rowid);
...
ALTER TABLE llx_immobilier_immoreceipt ADD INDEX idx_immobilier_immoreceipt_paye (paye);
...
ALTER TABLE llx_immobilier_immoreceipt ADD INDEX idx_immobilier_immoreceipt_model_pdf (model_pdf);
