...
--ALTER TABLE llx_ultimateimmo_immocompteur ADD CONSTRAINT llx_ultimateimmo_immocompteur_fk_field FOREIGN KEY (fk_field) REFERENCES llx_ultimateimmo_myotherobject(rowid);
