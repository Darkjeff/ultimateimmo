...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->rowid;
	header("Location: ".DOL_URL_ROOT('/immobilier/renter/immorenter_card.php',1).'?id='.$id);
	exit;
}
...
$newcardbutton='';
$newcardbutton='<a class="butActionNew" href="' .dol_buildpath('/immobilier/renter/immorenter_card.php',1) . '?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']).'"><span class="valignmiddle">'.$langs->trans('New').'</span>';
