...
$contextpage = GETPOST('contextpage', 'aZ') ? GETPOST('contextpage', 'aZ') : 'immorenter'; // To manage different context of search
...
$hookmanager->initHooks(array('immorenter'));     // Note that conf->hooks_modules contains array
