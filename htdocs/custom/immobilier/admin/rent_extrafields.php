...
/**
 *      \file       immobilier/admin/rent_extrafields.php
 *		\ingroup    immobilier
...
$elementtype='immobilier_immorent'; // Must be the $table_element of the class that manage extrafield
...
dol_fiche_head($head, 'attributes_rent', $langs->trans("ModuleImmobilierName"), 0, 'building@immobilier');
