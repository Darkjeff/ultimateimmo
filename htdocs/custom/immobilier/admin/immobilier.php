...
/**
 * \file    immobilier/admin/immobilier.php
 * \ingroup immobilier
...
{
    $conf->global->IMMOBILIER_ADDON_NUMBER='mod_immobilier_immo';
}
...
dol_fiche_head($head, 'settings', $langs->trans("Module113050Name"), -1, "immobilier@immobilier");
