	...
	public function __construct($db)
	{
		...
		*/
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorenter_type',
								'url'=>'/immobilier/renter_type/immorenter_type_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
								...
								'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		$this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=immobilier,fk_leftmenu=immobilier_immorenter_type',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'New ImmoRenter_Type',
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorenter_type',
								'url'=>'/immobilier/renter_type/immorenter_type_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immoowner',
								'url'=>'/immobilier/immoowner_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immoowner',
								'url'=>'/immobilier/immoowner_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'url'=>'/immobilier/immopayment_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immopayment',
								'url'=>'/immobilier/immopayment_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immoproperty',
								'url'=>'/immobilier/immoproperty_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immoproperty',
								'url'=>'/immobilier/immoproperty_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immoreceipt',
								'url'=>'/immobilier/immoreceipt_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immoreceipt',
								'url'=>'/immobilier/immoreceipt_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorent',
								'url'=>'/immobilier/immorent_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorent',
								'url'=>'/immobilier/immorent_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorenter',
								'url'=>'/immobilier/immorenter_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorenter_type',
								'url'=>'/immobilier/immorenter_type_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immorenter_type',
								'url'=>'/immobilier/immorenter_type_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=immobilier',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'List ImmoBuilding',
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immobuilding',
								'url'=>'/immobilier/immobuilding_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
								...
								'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		$this->menu[$r++]=array(
                				'fk_menu'=>'fk_mainmenu=immobilier,fk_leftmenu=immobilier_immobuilding',	    // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
								'type'=>'left',			                // This is a Left menu entry
								'titre'=>'New ImmoBuilding',
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immobuilding',
								'url'=>'/immobilier/immobuilding_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'url'=>'/immobilier/immocost_list.php',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r++]=array(
								...
								'mainmenu'=>'immobilier',
								'leftmenu'=>'immobilier_immocost',
								'url'=>'/immobilier/immocost_card.php?action=create',
								'langs'=>'immobilier@immobilier',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
								'position'=>1100+$r,
								'enabled'=>'$conf->immobilier->enabled',  // Define condition to show or hide menu entry. Use '$conf->immobilier->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
								'perms'=>'1',			                // Use 'perms'=>'$user->rights->immobilier->level1->level2' if you want your menu with a permission rules
