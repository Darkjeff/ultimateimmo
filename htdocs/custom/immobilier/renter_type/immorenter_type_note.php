...
/**
 *  \file       immorenter_type_note.php
 *  \ingroup    immobilier
 *  \brief      Car with notes on ImmoRenter_Type
 */
...
$help_url='';
llxHeader('',$langs->trans('ImmoRenter_Type'),$help_url);
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("ImmoRenter_Type"), -1, 'immorenter_type@immobilier');
