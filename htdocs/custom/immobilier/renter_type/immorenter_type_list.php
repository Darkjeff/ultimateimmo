...
$hookmanager->initHooks(array('immorenter_typelist'));     // Note that conf->hooks_modules contains array
...
if (empty($reshook))
{
	...
	// Mass actions
	$objectclass='ImmoRenter_Type';
	$objectlabel='ImmoRenter_Type';
...
$help_url='';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("ImmoRenter_Types"));
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."immorenter_type_extrafields as ef on (t.rowid = ef.fk_object)";
if ($object->ismultientitymanaged == 1) $sql.= " WHERE t.entity IN (".getEntity('immorenter_type').")";
else $sql.=" WHERE 1 = 1";
...
if ($num == 1 && ! empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all)
{
	...
	$id = $obj->rowid;
	header("Location: ".DOL_URL_ROOT.'/immobilier/renter_type/immorenter_type_card.php?id='.$id);
	exit;
}
...
$topicmail="SendImmoRenter_TypeRef";
$modelmail="immorenter_type";
$objecttmp=new ImmoRenter_Type($db);
