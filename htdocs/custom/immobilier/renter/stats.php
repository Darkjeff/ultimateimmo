...
/**
 *  \file       htdocs/custom/immobilier/renter/stats.php
 *  \ingroup    immobilier
...
dol_include_once("/immobilier/class/renterstats.class.php");
...
if (empty($conf->immobilier->enabled)) accessforbidden();
...
$fileurlnb = DOL_URL_ROOT.'/viewimage.php?modulepart=immobilier_temp&amp;file=outcomesnbinyear-'.$year.'.png';
...
$fileurlamount = DOL_URL_ROOT.'/viewimage.php?modulepart=immobilier_temp&amp;file=outcomesamountinyear-'.$year.'.png';
...
$head = renter_prepare_head(null);

dol_fiche_head($head, 'stats', $langs->trans("Renters"), 0, 'generic');
