...
require_once '../class/propertystats.class.php';
...
llxHeader();
	...
	$title=$langs->trans("PropertyStatistics");
...
if (! $mesg)
{
	...
	$px1->SetYLabel($langs->trans("NumberOfRenter"));
	$px1->SetShading(3);
	$px1->SetHorizTickIncrement(1);
	$px1->SetPrecisionY(0);
	$px1->mode='depth';
	$px1->SetTitle($langs->trans("NumberOfRenterByMonth"));
...
print '<td align="right">'.$langs->trans("NumberOfRenter").'</td>';
print '<td align="right">%</td>';
print '<td align="right">'.$langs->trans("AmountTotal").'</td>';
print '<td align="right">%</td>';
print '<td align="right">'.$langs->trans("AmountCostTotal").'</td>';
print '<td align="right">%</td>';
print '</tr>';
