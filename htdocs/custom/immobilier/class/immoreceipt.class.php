...
class ImmoReceipt extends CommonObject
{
	...
	public $fields=array(
		...
		'rentamount' => array('type'=>'double(24,8)', 'label'=>'RentAmount', 'enabled'=>1, 'visible'=>1, 'position'=>40, 'notnull'=>-1,),
		...
		'fk_contract' => array('type'=>'integer:ImmoRent:immobilier/class/immorent.class.php', 'label'=>'Contract', 'enabled'=>1, 'visible'=>1, 'position'=>52, 'notnull'=>-1,),
		'fk_property' => array('type'=>'integer:ImmoProperty:immobilier/class/immoproperty.class.php', 'label'=>'Property', 'enabled'=>1, 'visible'=>1, 'position'=>54, 'notnull'=>-1,),
		'fk_renter' => array('type'=>'integer:ImmoRenter:immobilier/class/immorenter.class.php', 'label'=>'Renter', 'enabled'=>1, 'visible'=>1, 'position'=>56, 'notnull'=>-1, 'index'=>1,),
		'fk_owner' => array('type'=>'integer:ImmoOwner:immobilier/class/immoowner.class.php', 'label'=>'Owner', 'enabled'=>1, 'visible'=>1, 'position'=>58, 'notnull'=>-1,),
	...
	public function fetchCommon($id, $ref = null)
	{
		...
		$sql .= ' LEFT JOIN ' . MAIN_DB_PREFIX . 'immobilier_immocontrat as ic ON t.fk_contract = ic.rowid';
