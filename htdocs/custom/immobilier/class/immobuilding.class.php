...
class ImmoBuilding extends CommonObject
{
	 ...
	 */
	public $table_element = 'immobilier_immobuilding';
	/**
	 * @var int  Does immobuilding support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test with link by societe
	 */
	public $ismultientitymanaged = 0;
	/**
	 * @var int  Does immobuilding support extrafields ? 0=No, 1=Yes
	 */
	 ...
	 */
	public $picto = 'immobuilding@immobilier';
	 ...
	 */
	//public $table_element_line = 'immobuildingdet';
	/**
	 * @var int    Field with ID of parent key if this field has a parent
	 */
	//public $fk_element = 'fk_immobuilding';
	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'ImmoBuildingline';
	/**
	 * @var array  Array of child tables (child tables to delete before deleting a record)
	 */
	//protected $childtables=array('immobuildingdet');
	/**
	 * @var ImmoBuildingLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	/*public function fetchLines()
	{
		...
		// Load lines with object ImmoBuildingLine
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("ImmoBuilding") . '</u>';
        $label.= '<br>';
        $label.= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

        $url = dol_buildpath('/immobilier/immobuilding_card.php',1).'?id='.$this->id;
