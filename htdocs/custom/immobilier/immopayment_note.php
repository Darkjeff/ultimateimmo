...
/**
 *  \file       immopayment_note.php
 *  \ingroup    immobilier
 *  \brief      Car with notes on ImmoPayment
 */
...
$hookmanager->initHooks(array('immopaymentnote'));     // Note that conf->hooks_modules contains array
...
if ($id > 0 || ! empty($ref))
{
	...
	dol_fiche_head($head, 'note', $langs->trans("ImmoPayment"), -1, 'immopayment@immobilier');
