...
--ALTER TABLE llx_immobilier_immocost ADD UNIQUE INDEX uk_immobilier_immocost_fieldxyz(fieldx, fieldy);

--ALTER TABLE llx_immobilier_immocost ADD CONSTRAINT llx_immobilier_immocost_field_id FOREIGN KEY (fk_field) REFERENCES llx_myotherobject(rowid);
