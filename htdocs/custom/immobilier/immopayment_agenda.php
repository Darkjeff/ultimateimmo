...
/**
 *  \file       immopayment_agenda.php
 *  \ingroup    immobilier
 *  \brief      Page of ImmoPayment events
 */
...
$hookmanager->initHooks(array('immopaymentagenda'));     // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	dol_fiche_head($head, 'agenda', $langs->trans("ImmoPayment"), -1, 'immopayment@immobilier');
