...
<!-- BEGIN PHP TEMPLATE -->
<?php
print_fiche_titre($langs->trans("NewRenter"));
...
*/
       // Prof ids
        ...
        while ($i <= 6)
        {
		//// change cabinetmed ----> real estate  TODO
...
*/
        print '<tr>';
        print '<td class="nowrap">'.$langs->trans('RenterVATIntra').'</td>';
...
<div align="center">
	<input type="submit" class="button" value="<?php echo $langs->trans('AddRenter'); ?>">
</div>
