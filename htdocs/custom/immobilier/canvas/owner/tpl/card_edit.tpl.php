...
<?php
print_fiche_titre($langs->trans("EditOwner"));
...
// Name
print '<tr><td class="titlefield"><span class="fieldrequired">'.$langs->trans('OwnerName').'</span></td><td colspan="3"><input type="text" size="40" maxlength="60" name="name" value="'.$object->name.'"></td>';
...
while ($i <= 6)
{
///// -------> change cabinetmed to realestate todo
...
// Num secu
print '<tr>';
print '<td class="nowrap">'.$langs->trans('OwnerVATIntra').'</td>';
