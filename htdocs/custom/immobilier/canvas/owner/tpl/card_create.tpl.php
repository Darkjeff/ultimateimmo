...
<tr>
	<td class="titlefield"><span class="fieldrequired"><?php echo $langs->trans('OwnerName'); ?></span></td>
	<td><input type="text" size="40" maxlength="60" name="name" value="<?php echo $object->name; ?>"></td>
    <td width="25%"><?php echo $langs->trans('OwnerCode'); ?></td>
    <td width="25%">
<?php
...
<div align="center">
	<input type="submit" class="button" value="<?php echo $langs->trans('AddOwner'); ?>">
</div>
