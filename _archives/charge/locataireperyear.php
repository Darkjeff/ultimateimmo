...
$textprevyear = "<a href=\"chargefournisseur.php?year=" . ($year_current - 1) . "\">" . img_previous () . "</a>";
$textnextyear = " <a href=\"chargefournisseur.php?year=" . ($year_current + 1) . "\">" . img_next () . "</a>";
...
$sql = "SELECT ic.fournisseur AS fournisseur, ii.nom AS nom_immeuble,";
...
$sql .= " GROUP BY ll.immeuble_id,ic.fournisseur";
