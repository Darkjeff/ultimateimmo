...
//require_once (DOL_DOCUMENT_ROOT."/gestimmo/mandat/class/contrat.class.php");
require_once (DOL_DOCUMENT_ROOT."/product/class/product.class.php");
//require_once (DOL_DOCUMENT_ROOT."/gestimmo/class/bien_immo.class.php");
...
$picto='biens';
dol_fiche_head($head, 'Gestions', $titre, 0, $picto);
print_fiche_titre($langs->trans("Gestion"));
...
{
    $var=false;
    print '<form method="post" action="'.DOL_URL_ROOT.'/gestimmo/mandat/liste.php">';
