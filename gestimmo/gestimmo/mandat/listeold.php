...
$sql.= " c.rowid as cid, c.ref_interne, c.datec, c.date_contrat, c.status,";
$sql.= " s.nom, s.rowid as socid";
$sql.= " FROM ".MAIN_DB_PREFIX."societe as s";
//if (!$user->rights->societe->client->voir && !$socid) $sql.= ", ".MAIN_DB_PREFIX."societe_commerciaux as sc";
$sql.= ", ".MAIN_DB_PREFIX."mandat as c";
...
if ($resql)
{
    ...
    print_barre_liste($langs->trans("ListOfmandats"), $page, $_SERVER["PHP_SELF"], '&search_contract='.$search_contract.'&search_nom='.$search_nom, $sortfield, $sortorder,'',$num);
