...
print $object->ref;
print $ref;
//if ($object->$id > 0 || ! empty($ref))
{
    $result = $object->fetch($id,$ref);
  //  print $id;
    
   // print $result;
    if (! empty($conf->gestimmo->enabled)) $upload_dir = $conf->gestimmo->multidir_output[$object->entity].'/'.dol_sanitizeFileName($object->ref);
...
if ($object->id)
{
	...
	$titre=$langs->trans("biens".$object->type);
 ...
 //print $form->showrefnav($object,'id','',1,'');
