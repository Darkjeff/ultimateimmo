...
class ImmoRenter extends CommonObject
{
	...
	public $fields = array(
		...
		'fk_soc' 		=> array('type' => 'integer:Societe:societe/class/societe.class.php:1:status=1 AND entity IN (__SHARED_ENTITIES__)', 'picto'=>'company', 'css' => 'minwidth300 widthcentpercentminusxx maxwidth500', 'label' => 'LinkedToDolibarrThirdParty', 'visible' => 1, 'enabled' => 1, 'position' => 32, 'notnull' => -1, 'index' => 1, 'help' => 'LinkToThirdparty'),
		'fk_project'        => array('type' => 'integer', 'label' => 'Project', 'enabled' => 1, 'visible' => 0, 'notnull' => 1, 'default' => 1, 'index' => 1, 'position' => 33),
		...
		'address'       => array('type' => 'varchar(255)', 'picto'=>'resource', 'label' => 'Address', 'enabled' => 1, 'visible' => 1, 'position' => 80, 'notnull' => -1),
		'zip'           => array('type' => 'varchar(32)', 'picto'=>'resource', 'label' => 'Zip', 'enabled' => 1, 'visible' => 1, 'position' => 81, 'notnull' => -1),
		'town'          => array('type' => 'varchar(64)', 'picto'=>'resource', 'label' => 'Town', 'enabled' => 1, 'visible' => 1, 'position' => 82, 'notnull' => -1),
		...
		'phone' => array('type' => 'varchar(30)', 'picto'=>'resource', 'label' => 'Phone', 'visible' => -1, 'enabled' => 1, 'position' => 88, 'notnull' => -1,),
		'phone_mobile' => array('type' => 'varchar(30)', 'picto'=>'resource', 'label' => 'PhoneMobile', 'visible' => 1, 'enabled' => 1, 'position' => 90, 'notnull' => -1,),
		'email' => array('type' => 'varchar(255)', 'picto'=>'email', 'label' => 'Email', 'visible' => 1, 'enabled' => 1, 'position' => 95, 'notnull' => -1,),
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$label = img_picto('', $this->picto) . '<u>' . $langs->trans("ImmoRenter") . '</u>';
		$label .= '<br>';
	...
	public function getLinesArray()
	{
		...
		$objectline = new ImmoRenterLine($this->db);
 ...
 *
 */
class ImmoRenterLine extends CommonObjectLine
{
