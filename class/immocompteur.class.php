...
/**
 * \file        class/immocompteur.class.php
 * \ingroup     ultimateimmo
 * \brief       This file is a CRUD class file for ImmoCompteur (Create/Read/Update/Delete)
 */
...
/**
 * Class for ImmoCompteur
 */
class ImmoCompteur extends CommonObject
{
	/**
	 * @var string ID to identify managed object.
	 */
	public $element = 'immocompteur';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'ultimateimmo_immocompteur';
	...
	public $fields=array(
		...
		'compteur_type_id' => array('type' => 'integer:ImmoCompteur_Type:ultimateimmo/class/immocompteur_type.class.php:1:(active:=:1)', 'label' => 'ImmoCompteurType', 'enabled' => 1, 'visible' => -1, 'position' => 20, 'notnull' => 1, 'help' => 'ImmoCompteurTypeInfo',),
	...
	public $rowid;
	public $ref;
	public $compteur_type_id;
	public $label;
	public $date_relever;
	public $qty;
	public $fk_immoproperty;
	public $description;
	public $note_public;
	public $note_private;
	 ...
	 */
	//public $table_element_line = 'ultimateimmo_immocompteurline';

	/**
	 * @var int    Field with ID of parent key if this object has a parent
	 */
	//public $fk_element = 'fk_immocompteur';

	/**
	 * @var int    Name of subtable class that manage subtable lines
	 */
	//public $class_element_line = 'ImmoCompteurline';
	 ...
	 */
	//protected $childtablesoncascade = array('ultimateimmo_immocompteurdet');

	/**
	 * @var ImmoCompteurLine[]     Array of subtable lines
	 */
	//public $lines = array();
	...
	public function setDraft($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_DRAFT, $notrigger, 'IMMOCOMPTEUR_UNVALIDATE');
	}
	...
	public function cancel($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_CANCELED, $notrigger, 'IMMOCOMPTEUR_CLOSE');
	}
	...
	public function reopen($user, $notrigger = 0)
	{
		...
		return $this->setStatusCommon($user, self::STATUS_VALIDATED, $notrigger, 'IMMOCOMPTEUR_REOPEN');
	}
	...
	public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
	{
		...
		if (!dol_strlen($modele)) {
			$modele = 'standard_immocompteur';

			if ($this->modelpdf) {
				$modele = $this->modelpdf;
			} elseif (!empty($conf->global->IMMOCOMPTEUR_ADDON_PDF)) {
				$modele = $conf->global->IMMOCOMPTEUR_ADDON_PDF;
			}
		}
...
/**
 * Class ImmoCompteurLine. You can also remove this and generate a CRUD class for lines objects.
 */
class ImmoCompteurLine
{
	// To complete with content of an object ImmoCompteurLine
	// We should have a field rowid, fk_immocompteur and position
