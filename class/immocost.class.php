...
class ImmoCost extends CommonObject
{
	...
	public $fields=array(
		...
		'label' => array('type' => 'varchar(255)', 'label' => 'Label', 'enabled' => 1, 'visible' => 1, 'position' => 30, 'notnull' => -1, 'searchall' => 1, 'help' => "ImmoCostLabelInfo", 'showoncombobox' => '1',),
		'fk_property' => array('type' => 'integer:ImmoProperty:ultimateimmo/class/immoproperty.class.php', 'label' => 'Property', 'enabled' => 1, 'visible' => 1, 'position' => 35, 'notnull' => -1, 'index' => 1, 'help' => "LinkToProperty",),
		'fk_owner' => array('type' => 'integer:ImmoOwner:ultimateimmo/class/immoowner.class.php', 'label' => 'Owner', 'enabled' => 1, 'visible' => 1, 'position' => 40, 'notnull' => -1, 'index' => 1, 'help' => "LinkToOwner",),
		'fk_soc' => array('type' => 'integer:Societe:societe/class/societe.class.php:1:status=1 AND entity IN (__SHARED_ENTITIES__)', 'picto' => 'company', 'label' => 'ThirdParty', 'visible' => 1, 'enabled' => 1, 'position' => 45, 'notnull' => -1, 'index' => 1, 'searchall' => 1, 'help' => "SetLinkToThirdparty",),
		'fk_cost_type' => array('type' => 'integer:ImmoCost_Type:ultimateimmo/class/immocost_type.class.php', 'label' => 'ImmoCostType', 'enabled' => 1, 'visible' => 1, 'position' => 50, 'notnull' => -1, 'index' => 1, 'help' => "CostType",),
		...
		'amount_ht' => array('type' => 'price', 'label' => 'HtAmount', 'enabled' => 1, 'visible' => 1, 'position' => 65, 'notnull' => -1, 'default' => 'null', 'isameasure' => '1', 'help' => "ImmoCostAmountExTaxInfo",),
		'amount_vat' => array('type' => 'price', 'label' => 'VatAmount', 'enabled' => 1, 'visible' => 1, 'position' => 68, 'notnull' => -1, 'default' => 'null', 'isameasure' => '1', 'help' => "ImmoCostAmountTaxInfo",),
	...
	function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$label = img_picto('', $this->picto) . '<u>' . $langs->trans("ImmoCost") . '</u>';
		$label .= '<br>';
		$label .= '<b>' . $langs->trans('Ref') . ':</b> ' . $this->ref;

		$url = dol_buildpath('/ultimateimmo/cost/immocost_card.php', 1) . '?id=' . $this->id;
