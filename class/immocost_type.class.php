...
class ImmoCost_Type extends CommonObject
{
	...
	public $fields=array(
		...
		'label' => array('type'=>'varchar(255)', 'label'=>'CostTypeLabel', 'enabled'=>1, 'visible'=>1, 'position'=>30, 'notnull'=>-1, 'searchall'=>1, 'help'=>"CostTypeLabelInfo", 'showoncombobox'=>'1',),
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("MenuListImmoCostType") . '</u>';
        $label.= '<br>';
        ...
        if (empty($notooltip))
        {
            ...
            {
                $label=$langs->trans("ShowImmoCost_Type");
