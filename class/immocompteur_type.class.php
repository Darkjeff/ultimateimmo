...
class ImmoCompteur_Type extends CommonObject
{
	 ...
	 */
	public $table_element = 'c_ultimateimmo_immocompteur_type';
	...
	public $fields=array(
		...
		'ref' =>array('type'=>'varchar(50)', 'label'=>'Ref', 'enabled'=>1, 'visible'=>-1, 'notnull'=>1, 'position'=>15),
	...
	function getNomUrl($withpicto=0, $option='', $notooltip=0, $morecss='', $save_lastsearch_value=-1)
	{
        ...
        $label = '<u>' . $langs->trans("MenuListImmoCompteurType") . '</u>';
        $label.= '<br>';
