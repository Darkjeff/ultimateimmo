...
class ImmoOwner extends CommonObjectUltimateImmo
{
	...
	public $fields = array(
		...
		'fk_soc' 		=> array('type' => 'integer:Societe:societe/class/societe.class.php:1:status=1 AND entity IN (__SHARED_ENTITIES__)', 'picto' => 'company', 'css' => 'minwidth300 widthcentpercentminusxx maxwidth500', 'label' => 'ThirdParty', 'visible' => 1, 'enabled' => 1, 'position' => 30, 'notnull' => -1, 'index' => 1, 'help' => 'SetLinkToThirdparty'),
		...
		'address' 		=> array('type' => 'varchar(255)', 'picto'=>'resource', 'label' => 'Address', 'enabled' => 1, 'visible' => 1, 'position' => 61, 'notnull' => -1,),
		'zip' 			=> array('type' => 'varchar(32)', 'picto'=>'resource', 'label' => 'Zip', 'enabled' => 1, 'visible' => 1, 'position' => 62, 'notnull' => -1,),
		'town' 			=> array('type' => 'varchar(64)', 'picto'=>'resource', 'label' => 'Town', 'enabled' => 1, 'visible' => 1, 'position' => 63, 'notnull' => -1,),
		'country_id' 	=> array('type' => 'integer', 'label' => 'Country', 'enabled' => 1, 'visible' => 1, 'position' => 64, 'notnull' => -1,),
		'email' 		=> array('type' => 'varchar(255)', 'picto'=>'email', 'label' => 'Email', 'visible' => -1, 'enabled' => 1, 'position' => 65, 'notnull' => 1, 'searchall' => 1,),
		'phone' 		=> array('type' => 'varchar(30)', 'picto'=>'resource', 'label' => 'Phone', 'visible' => -1, 'enabled' => 1, 'position' => 75, 'notnull' => -1,),
		'phone_mobile' 	=> array('type' => 'varchar(30)', 'picto'=>'resource', 'label' => 'PhoneMobile', 'visible' => -1, 'enabled' => 1, 'position' => 80, 'notnull' => -1,),
	...
	public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
	{
		...
		$label = img_picto('', $this->picto) . '<u>' . $langs->trans("ImmoOwner") . '</u>';
		$label .= '<br>';
...
class ImmoOwnerLine extends CommonObjectLine
{
